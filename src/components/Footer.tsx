...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-white border-t border-primary-light/20 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-secondary">Quick Links</h3>
            <ul className="space-y-2 text-sm font-medium">
              <li>
                <Link href="/" className="text-white/80 hover:text-secondary transition-colors duration-200">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/shop" className="text-white/80 hover:text-secondary transition-colors duration-200">
                  Shop Catalog
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white/80 hover:text-secondary transition-colors duration-200">
                  Our Story
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-white/80 hover:text-secondary transition-colors duration-200">
                  Get In Touch
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Details */}
          <div className="space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-secondary">Contact Info</h3>
            <ul className="space-y-3 text-sm text-white/80">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`mailto:${siteConfig.email}`} className="hover:text-secondary transition-colors duration-200">
                  {siteConfig.email}
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href={siteConfig.whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors duration-200">
                  {siteConfig.phone}
                </a>
              </li>
            </ul>
